	...
	<tbody>
		...
		<tr>
			<th scope="row">
				...
				<input type="text" class="regular-text" autocomplete="off" spellcheck="false" x-webkit-speech="false" id="shadow" name="shadow" value="<?php esc_html_e(openSug_value($cfg, 'shadow', "0 16px 10px rgb(0 0 0 / 50%)"));?>" placeholder="0 16px 10px rgb(0 0 0 / 50%)" />
			</td>
		</tr>
		<tr>
			<th scope="row">
